...
namespace Markocupic\ContaoFlashMessage\Controller\FrontendModule;
...
#[AsFrontendModule(category: 'flash_modules')]
class FlashModuleController extends AbstractFrontendModuleController
{
    public const TYPE = 'flash_module';
